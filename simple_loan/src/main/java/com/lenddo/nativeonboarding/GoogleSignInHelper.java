...
import com.lenddo.sdk.core.LenddoClient2;
import com.lenddo.sdk.dialogs.WebAuthorizeFragment;
import com.lenddo.sdk.http.OnLenddoQueryCompleteListener;
import com.lenddo.sdk.models.GoogleSigninBody;
import com.lenddo.sdk.utils.SignInHelper;
...
public class GoogleSignInHelper implements SignInHelper, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private GoogleSigninBody googleSigninBody = new GoogleSigninBody();
    ...
    private void onboardGoogleSignin(final Context context, String request, String servicetoken, final OnLenddoQueryCompleteListener listener) {
        LenddoClient2.postProfilesClientToken("google", request, servicetoken, new OnLenddoQueryCompleteListener() {
            @Override
        ...
        AsyncTask<Void, Void, String > task = new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String token) {
                ...
                onboardGoogleSignin(mFragment.getActivity().getApplicationContext(),
                        ...
                        LenddoClient2.getOnboardingServiceToken(), new OnLenddoQueryCompleteListener() {
                            @Override
                            public void onComplete(String rawResponse) {
                                Log.d(TAG, "onPostExecute(): "+rawResponse);
                                mFragment.loadURL(null, LenddoClient2.getBaseUrl()+"/sync/success");
                            }

                            @Override
                            public void onError(int statusCode, String rawResponse) {
                                Log.e(TAG, "onPostExecute() Error: "+rawResponse);
                                mFragment.loadURL(null, LenddoClient2.getBaseUrl()+"/sync/error");
                            }
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            mFragment.loadURL(null, LenddoClient2.getBaseUrl()+"/sync/cancel");
        }
    }
}
